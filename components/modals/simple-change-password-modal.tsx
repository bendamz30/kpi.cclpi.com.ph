...
interface SimpleChangePasswordModalProps {
  children: React.ReactNode
}

export function SimpleChangePasswordModal({ children }: SimpleChangePasswordModalProps) {
      ...
      <DialogContent className="sm:max-w-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <Input
                ...
                onChange={(e) => {
                  console.log('Current password input changed:', e.target.value)
          ...
          <div className="text-xs text-gray-500 p-2 bg-gray-50 rounded">
            <p>Debug: Current: "{formData.currentPassword}" | New: "{formData.newPassword}" | Confirm: "{formData.confirmPassword}"</p>
          </div>
